    ...
    <nav className="bottom-nav">
      ...
      <div className="hidden lg:flex flex-col w-full h-full">
        ...
        <div className="nav-items-container font-sans">
          ...
          <Link href="/create" className="nav-fab group">
      ...
      {/* ─── MOBILE BOTTOM NAV ─── */}
      <div className="lg:hidden flex w-full items-center justify-between pb-[env(safe-area-inset-bottom,0px)]">
        <Link href="/inbox" className={`nav-item ${activeTab === 'inbox' ? 'active' : ''}`}>
          <div className="nav-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={stroke('inbox')} strokeWidth="1.8">
              <path d="M20 4H4a1 1 0 00-1 1v14a1 1 0 001 1h16a1 1 0 001-1V5a1 1 0 00-1-1z"/><path d="M3 7l9 6 9-6"/>
            </svg>
          </div>
        </Link>
        ...
        <Link href="/scheduled" className={`nav-item ${activeTab === 'sent' ? 'active' : ''}`}>
          <div className="nav-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={stroke('sent')} strokeWidth="1.8">
              <path d="M22 2L11 13"/><path d="M22 2L15 22 11 13 2 9l20-7z"/>
            </svg>
          </div>
        </Link>
        ...
        <Link href="/games" className={`nav-item ${activeTab === 'games' ? 'active' : ''}`}>
          <div className="nav-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={stroke('games')} strokeWidth="1.8">
        ...
        <Link href="/profile" className={`nav-item ${activeTab === 'profile' ? 'active' : ''}`}>
          <div className="nav-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={stroke('profile')} strokeWidth="1.8">
              <circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/>
            </svg>
          </div>
        </Link>
